...
import { StyleSheet, View, Alert, TextInput, TouchableOpacity, Image, StatusBar, ImageBackground, Keyboard, Text, KeyboardAvoidingView, ScrollView, Platform, } from 'react-native';
...
const ForgetPassword: React.FC<ForgetPasswordProps> = ({ navigation, route }) => {
  ...
  const requestOtp = async (): Promise<void> => {
    try {
      const response = await apiClient.get('/api/mobile/user/forgotpassword/otp', {
        params: {
          mobile
            : mobileno
        },
  ...
  const resetPassword = async (): Promise<void> => {
    ...
    try {
      const response = await apiClient.put('/api/mobile/user/forgotpassword/reset', {
        mobile: mobileno,
        otp,
